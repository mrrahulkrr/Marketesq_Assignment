  ...
  return (
    <Dropdown>
      ...
      <DropdownMenu className="rounded-2xl border-2 border-slate-800 text-white pt-5"  aria-label="Static Actions">
        <DropdownItem className="border-x-2 hover:border-slate-400"  key="login">Login</DropdownItem>
        <DropdownItem className="border-x-2 hover:border-slate-400" key="sign up">Sign up</DropdownItem>
        <DropdownItem className="border-x-2 hover:border-slate-400" key="about">About</DropdownItem>
